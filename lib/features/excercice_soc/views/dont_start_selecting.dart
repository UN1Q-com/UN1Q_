...
class DontStartSelectingPage extends StatefulWidget {
  const DontStartSelectingPage({super.key});

  @override
  State<DontStartSelectingPage> createState() => _DontStartSelectingPage();
}

class _DontStartSelectingPage extends State<DontStartSelectingPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<ExerciseBloc, ExerciseState>(builder: (ctx, state) {
        if (state is DontStartLoadedFormState) {
                    ...
                    children: [
                      ...
                      RadioButton(
                        ...
                        onChanged: (value) {
                          ...
                          context.read<ExerciseBloc>().add(SelectFirstApply());
                        },
                      ),
                      ...
                      RadioButton(
                        ...
                        onChanged: (value) {
                          ...
                          context.read<ExerciseBloc>().add(SelectLastApply());
                        },
                      ),
                      const SizedBox(height: ThemeSpacing.xlg),
                    ],
